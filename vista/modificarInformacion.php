...
.fancybox-custom .fancybox-skin {
    ...
    <div class="caja_login">
      <div style="text-align:center; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#551BF4;">
        <h1 align="center">Panel del Cliente</h1>
        <input type="text" name="boxBuscar" id="boxBuscar" autofocus="autofocus" value="" placeholder="Ingrese dato a buscar." />
        <input type="submit" name="botonBuscar" value="Buscar" id="botonBuscar" />
        <br />
        <br />
        <input type="submit" name="botonListar" value="Listar Todos los Clientes" id="botonListar" />

        <a href="index.php"> <br /><br /> <br />Registrar Cliente</a>
        <br />
        <br />
