...
//funcion modificarInformacion() que permite obtener los datos de la base de datos para poder modificarlos.
    ...
    estado_id = document.getElementById("estado_id_editar").value;
		...
		if(nombre!="" && estado_id!="" && apellidos!="" && telefono!="" && email!=""){
			ajax_("../controlador/controlador.php?nombre_editar="+nombre+"&estado_id_editar="+estado_id+"&apellidos_editar="+apellidos+"&telefono_editar="+telefono+"&email_editar="+email+"&id_editar="+id);
		}else{
...
<form>
  ...
  <table width="200" border="0" align="center">
    ...
    <tr>
      <td colspan="3" align="center"><input type="button" value="Editar" onclick="modificarInformacion();" /></td>
    </tr>
  </table>
